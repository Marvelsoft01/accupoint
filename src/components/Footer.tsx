        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-8">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-primary-foreground/80">+1 907 416 3145</span>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="h-5 w-5 text-accent flex-shrink-0" />
                <span className="text-primary-foreground/80">info@accupointruck.com</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/terms-conditions" className="text-primary-foreground/80 hover:text-accent transition-colors">
                  Terms & Conditions
                </Link>
              </li>
              <li>
                <Link to="/sms-consent" className="text-primary-foreground/80 hover:text-accent transition-colors">
                  SMS Consent
                </Link>
              </li>
            </ul>
